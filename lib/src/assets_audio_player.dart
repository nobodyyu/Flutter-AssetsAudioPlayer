    ...
    _recieveChannel.setMethodCallHandler((MethodCall call) async {
      ...
      switch (call.method) {
        ...
        case METHOD_FORWARD_REWIND_SPEED:
          ...
          break;
        default:
          debugPrint('[ERROR] Channel method ${call.method} not implemented.');
      }
    });
      ...
      try {
        ...
        final errorHandler = ErrorHandler(
          ...
          error: const AssetsAudioPlayerError(
            errorType: AssetsAudioPlayerErrorType.player,
            message: '',
          ),
        );
        if (onErrorDo != null) {
  ...
  Future<void> seekBy(Duration by) async {
    ...
    if (playing != null) {
      ...
      final currentPosition =
          this.currentPosition.valueOrNull ?? const Duration();
